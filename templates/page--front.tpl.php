    ...
    <div class="container">
      <div class="row">
        <div class="cornell-logo">
          <a href="http://www.cornell.edu"><img src="/sites/all/themes/catherwood/img/cornell.gif" alt="Cornell University"></a>
        </div>
...
<script type="text/javascript">
  ...
  var randomImages = ['1','3','4','2']; 
  var rndNum = Math.floor(Math.random() * randomImages.length); 
  jQuery(".hero-front").css({ background: "url('/sites/all/themes/catherwood/img/hero/" + randomImages[rndNum] + ".jpg') no-repeat" }); });
</script>